<template>
  <div class="AddressSelect">
        ...
        ></el-cascader>
        <div v-if="checkCountry" class="country">
          <span>省市：</span>
          <el-cascader
          filterable
          v-model="valueProvince"
          :options="china"
          @change="handleChangeProvince"></el-cascader>
        </div>
  </div>
</template>
